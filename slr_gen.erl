...
gen() ->
    io:format("~s~n", [gen('query', python)]),
    io:format("~s~n", [format_grammar(python, grammar('query'))]),
    io:format("~s~n", [gen(code, python)]),
    io:format("~s~n", [format_grammar(python, grammar(code))]).
